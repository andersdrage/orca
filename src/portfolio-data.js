...
export const portfolioCases = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'uber-ueno-usa-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-china-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-singapore-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-india-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-france-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-ireland-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-australia-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-nl-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-mexico-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-morocco-full.jpg', span: 'full', alt: 'Uber' },
      ...
      { file: 'uber-ueno-ipad-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-iphone-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-headers-full.mp4', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-step1-full.mp4', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-step2-full.mp4', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-step4-full.mp4', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-career-1-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-career-2-full.jpg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-split.svg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-destination.svg', span: 'full', alt: 'Uber' },
      { file: 'uber-ueno-request.svg', span: 'full', alt: 'Uber' },
    ],
  },
  {
    id: 'boligmappa',
