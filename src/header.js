...
function initSpeculationRules() {
  ...
  script.textContent = JSON.stringify({
    prefetch: [{ urls: ['/', '/micromilspec/', '/hjemla/', '/hmkg/', '/off-market/', '/misc/', '/mountain-milk/', '/humming-people/', '/finn/', '/nettavisen/', '/brathwait/', '/about/', '/praise/', '/archive/', '/people/'], eagerness: 'immediate' }],
    ...
    prerender: [
      ...
      { urls: ['/off-market/', '/misc/', '/hmkg/', '/mountain-milk/', '/humming-people/', '/finn/', '/nettavisen/', '/brathwait/'], eagerness: 'moderate' },
...
function warmCaseAssets() {
  ...
  const casePages = ['/micromilspec/', '/hjemla/', '/hmkg/', '/off-market/', '/misc/', '/mountain-milk/', '/humming-people/', '/finn/', '/nettavisen/', '/brathwait/']
