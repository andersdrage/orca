...
function initSpeculationRules() {
  ...
  script.textContent = JSON.stringify({
    prefetch: [{ urls: ['/', '/micromilspec/', '/hjemla/', '/hmkg/', '/off-market/', '/misc/', '/mountain-milk/', '/humming-people/', '/about/', '/praise/', '/archive/'], eagerness: 'immediate' }],
    ...
    prerender: [
      ...
      { urls: ['/off-market/', '/misc/', '/hmkg/', '/mountain-milk/', '/humming-people/'], eagerness: 'moderate' },
...
function warmCaseAssets() {
  ...
  const casePages = ['/micromilspec/', '/hjemla/', '/hmkg/', '/off-market/', '/misc/', '/mountain-milk/', '/humming-people/']
